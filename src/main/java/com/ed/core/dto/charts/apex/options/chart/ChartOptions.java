...
*/
package com.ed.core.dto.charts.apex.options.chart;
...
public class ChartOptions {
   ...
   * @param stacked enables stacked option for axis charts. Note: A stacked chart works only for
   *     same chart types and won’t work in combo/mixed charts combinations. So, an area series
   *     combined with a column series will not work.
   * @param height height of the chart in pixel
   * @param zoomOptions zoomOptions configuration in axis charts, see {@link ZoomOptions} for
   *     details
   * @param animations animation configuration, see {@link Animations} for details
   * @param dynamicAnimation dynamic animation configuration, see {@link DynamicAnimation} for
   *     details
   */
  public ChartOptions(
      ChartType type,
   ...
   */
  public ChartOptions(
      ChartType type, Boolean stacked, int height, ZoomOptions zoomOptions, Animations animations) {
