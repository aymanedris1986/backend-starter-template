...
/**
 * Enable or disable ALL animations that happen initially or during data update. If enabled is set
 * to false all other animations (e.g. {@link AnimateGradually} or {@link DynamicAnimation}) won't
 * work!
 *
 * @version 0.1
 * @since 14.01.20
